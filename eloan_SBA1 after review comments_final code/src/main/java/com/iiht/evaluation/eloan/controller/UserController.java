...
private IUserService userService;
	...
	public void init(ServletConfig config) {
		...
		userService = new UserServiceImpl(jdbcURL, jdbcUsername, jdbcPassword);
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "/logout":
				...
				break;
			case "/home":
				viewName = home(request, response);
				break;
	...
	private String validate(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		return null;
	}
	private String placeloan(HttpServletRequest request, HttpServletResponse response) {
		return null;
	}
	private String application1(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException{
		return "application.jsp";
	}
	private String editLoanProcess(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		if(request.getParameter("loanid") != null){
			int loanId= Integer.parseInt(request.getParameter("loanid"));
			LoanInfo loan = userService.getLoanById(loanId);
			request.setAttribute("loan", loan);
		}
		
		return "loanDetails.jsp";
	}
	private String registerUser(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException	 {
	...
	private String registernewuser(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		...
		User user = userService.saveAndGet(username,email,password,phone, phone);
		String info;
		if(user != null){
	...
	private String displaystatus(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		// TODO Auto-generated method stub
	...
	private String editloan(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException{
		// TODO Auto-generated method stub
	/* write a code to return to editloan page */
		...
		if(loan.getUserId() !=userid){
			...
			userService.updateLoan(loanId, loanname,loanamount,businessstruture,taxindiacator,address1,address2,address3);
	...
	private String trackloan(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		// TODO Auto-generated method stub
		int userId = Integer.parseInt(request.getParameter("userid"));
		List<LoanInfo> loans = userService.getLoanStatus(userId);
		request.setAttribute("loans", loans);
		return "trackloan.jsp";
	}

	private String application(HttpServletRequest request, HttpServletResponse response) throws AccessDeniedException {
		// TODO Auto-generated method stub
	/* write a code to return to trackloan page */		
		...
		LoanInfo loans = userService.addLoan(loanname,loanamount,businessstruture,taxindiacator,address1,address2,address3,u1.getId());
		if(loans != null){
